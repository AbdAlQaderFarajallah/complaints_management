...
MailsOfCategory mailsOfCategoryFromJson(String str) => MailsOfCategory.fromJson(json.decode(str));

String mailsOfCategoryToJson(MailsOfCategory data) => json.encode(data.toJson());
...
class MailsOfCategory {
  ...
  factory MailsOfCategory.fromJson(Map<String, dynamic> json) => MailsOfCategory(
