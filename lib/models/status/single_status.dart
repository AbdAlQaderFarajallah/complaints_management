...
class Mails {
  ...
  Mails.fromJson(Map<String, dynamic> json) {
    ...
    substatus = json['status'] != null
        ? Substatus.fromJson(json['status'])
        : null;
    if (json['tags'] != null) {
      tags = <Tags>[];
      json['tags'].forEach((v) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.substatus != null) {
      data['status'] = this.substatus!.toJson();
    }
    if (this.tags != null) {
...
class Substatus {
  ...
  Substatus({this.id, this.name, this.color});
